...
static gboolean
gtk_icon_view_item_accessible_action_do_action (void *action,
                                                gint       i)
{
  GtkIconViewItemAccessible *item;
...
static gint
gtk_icon_view_item_accessible_action_get_n_actions (void *action)
{
        return LAST_ACTION;
}

static const gchar *
gtk_icon_view_item_accessible_action_get_description (void *action,
                                                      gint       i)
{
  GtkIconViewItemAccessible *item;
...
static const gchar *
gtk_icon_view_item_accessible_action_get_name (void *action,
                                               gint       i)
{
  if (i < 0 || i >= LAST_ACTION) 
    return NULL;
...
static gboolean
gtk_icon_view_item_accessible_action_set_description (void   *action,
                                                      gint         i,
...
static const gchar *
gtk_icon_view_item_accessible_image_get_image_description (void *image)
{
  GtkIconViewItemAccessible *item;
...
static gboolean
gtk_icon_view_item_accessible_image_set_image_description (void    *image,
                                                           const gchar *description)
{
  GtkIconViewItemAccessible *item;
...
static void
gtk_icon_view_item_accessible_image_get_image_size (void *image,
                                                    gint     *width,
                                                    gint     *height)
{
}
...
static void
gtk_icon_view_item_accessible_image_get_image_position (void    *image,
                                                        gint        *x,
                                                        gint        *y,
                                                        void* coord_type)
{
...
static gchar *
gtk_icon_view_item_accessible_text_get_text (void *text,
                                             gint     start_pos,
                                             gint     end_pos)
{
  return NULL;
...
static gunichar
gtk_icon_view_item_accessible_text_get_character_at_offset (void *text,
                                                            gint     offset)
{
  return '\0';
}
...
static gchar*
gtk_icon_view_item_accessible_text_get_text_before_offset (void         *text,
                                                           gint            offset,
                                                           void* boundary_type,
                                                           gint            *start_offset,
                                                           gint            *end_offset)
...
static gchar*
gtk_icon_view_item_accessible_text_get_text_at_offset (void         *text,
                                                       gint            offset,
                                                       void* boundary_type,
                                                       gint            *start_offset,
                                                       gint            *end_offset)
...
static gchar*
gtk_icon_view_item_accessible_text_get_text_after_offset (void         *text,
                                                          gint            offset,
                                                          void* boundary_type,
                                                          gint            *start_offset,
                                                          gint            *end_offset)
...
static gint
gtk_icon_view_item_accessible_text_get_character_count (void *text)
{
  return 0;
}

static void
gtk_icon_view_item_accessible_text_get_character_extents (void      *text,
                                                          gint         offset,
                                                          gint         *x,
                                                          gint         *y,
                                                          gint         *width,
...
static gint
gtk_icon_view_item_accessible_text_get_offset_at_point (void      *text,
                                                        gint          x,
                                                        gint          y,
                                                        void* coord_type)
{
...
static void
gtk_icon_view_item_accessible_get_extents (void *component,
                                           gint         *x,
                                           gint         *y,
                                           gint         *width,
                                           gint         *height,
...
static gboolean
gtk_icon_view_item_accessible_grab_focus (void *component)
{
  return FALSE;
}
...
static void*
gtk_icon_view_item_accessible_get_parent (void *obj)
{
  GtkIconViewItemAccessible *item;
...
static gint
gtk_icon_view_item_accessible_get_index_in_parent (void *obj)
{
  GtkIconViewItemAccessible *item;
...
static void *
gtk_icon_view_item_accessible_ref_state_set (void *obj)
{
  return NULL;
}
...
gtk_icon_view_accessible_get_priv (void *accessible)
{
...
static void
gtk_icon_view_item_accessible_info_new (void *accessible,
                                        void *item,
                                        gint       index)
{
...
static gint
gtk_icon_view_accessible_get_n_children (void *accessible)
{
  GtkIconView *icon_view;
  GtkWidget *widget;
...
static void *
gtk_icon_view_accessible_find_child (void *accessible,
                                     gint       index)
{
  return NULL;
}
...
static void *
gtk_icon_view_accessible_ref_child (void *accessible,
                                    gint       index)
{
  return NULL;
}
...
static void*
gtk_icon_view_accessible_ref_accessible_at_point (void *component,
                                                  gint          x,
                                                  gint          y,
                                                  void* coord_type)
{
...
static gboolean
gtk_icon_view_accessible_add_selection (void *selection,
                                        gint i)
{
  return FALSE;
}
...
static gboolean
gtk_icon_view_accessible_clear_selection (void *selection)
{
  return FALSE;
}

static void*
gtk_icon_view_accessible_ref_selection (void *selection,
                                        gint          i)
{
  return NULL;
}
...
static gint
gtk_icon_view_accessible_get_selection_count (void *selection)
{
  return 0;
}

static gboolean
gtk_icon_view_accessible_is_child_selected (void *selection,
                                            gint          i)
{
   return FALSE;
}
...
static gboolean
gtk_icon_view_accessible_remove_selection (void *selection,
                                           gint          i)
{
  return FALSE;
}
...
static gboolean
gtk_icon_view_accessible_select_all_selection (void *selection)
{
  return FALSE;
}
